...
async def check_integration_report(integration_report):
    json_int_report = json.loads(integration_report)


class InvalidIntegrationReport(Exception):
    """Error to indicate invalid integration report."""
